...
remove_customization(Account) ->
    remove_customization(Account, list_templates_from_db(kzd_account:format_account_db(Account))).
...
remove_customization(Account, Ids) ->
    ...
    case kz_datamgr:del_docs(kzd_account:format_account_db(Account), Ids) of
        {'ok', JObjs} ->
