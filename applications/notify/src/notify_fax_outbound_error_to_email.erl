...
-define(DEFAULT_TEXT_TMPL, 'notify_fax_outbound_error_to_email_text_tmpl').
-define(DEFAULT_HTML_TMPL, 'notify_fax_outbound_error_to_email_html_tmpl').
-define(DEFAULT_SUBJ_TMPL, 'notify_fax_outbound_error_to_email_subj_tmpl').
...
handle_req(JObj, _Props) ->
    ...
    {'ok', AcctObj} = kzd_account:fetch(kz_json:get_value(<<"Account-ID">>, JObj)),
